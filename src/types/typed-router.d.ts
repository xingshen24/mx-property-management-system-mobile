...
declare module 'vue-router/auto-routes' {
  ...
  export interface _RouteFileInfoMap {
    ...
    'src/pages/general-affair/meeting/detail.vue': {
      routes: 'MeetingDetail'
      views: never
    }
    'src/pages/general-affair/month-meeting/index.vue': {
      routes: 'MonthMeeting'
      views: never
    }
    'src/pages/general-affair/office-meeting-resolution/index.vue': {
      routes: 'OfficeMeetingResolution'
      views: never
    }
    ...
    'src/pages/general-affair/proposal/detail.vue': {
      routes: 'ProposalDetail'
      views: never
    }
    'src/pages/general-affair/publish-article/index.vue': {
      routes: 'PublishArticle'
      views: never
    }
    ...
    'src/pages/human-resource/insurance/detail.vue': {
      routes: 'EmployeeInsuranceDetail'
      views: never
    }
