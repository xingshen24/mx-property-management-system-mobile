<template>
  <div class="page-wrapper">
    ...
    <van-cell-group inset>
      <van-cell title="申请员工" :value="detail.empName" />
      <van-cell title="工所在部门" :value="detail.deptName" />
      <van-cell title="申请时间" :value="detail.applyTime" />
      <van-cell title="加班开始时间" :value="detail.beginTime" />
      <van-cell title="加班结束时间" :value="detail.endTime" />
      <van-cell title="加班时长" :value="`${detail.workHours}小时`" />
      <van-cell title="加班原因" :value="detail.reason" />
      <van-cell title="加班发起人" :value="detail.promoteEmpName" />
...
<script setup lang="ts" name="OvertimeTicketDetail">
...
Api.req('/overtime-ticket/detail-for-view').query({ id }).success(data => {
